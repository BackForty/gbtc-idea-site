# RailsAdmin config file. Generated on May 23, 2013 13:11
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Comment', 'Event', 'Idea', 'User', 'Vote']

  # Include specific models (exclude the others):
  # config.included_models = ['Comment', 'Event', 'Idea', 'User', 'Vote']
